...
JNIEXPORT void Java_org_telegram_messenger_Intro_onSurfaceCreated(JNIEnv *env, jclass class) {
    ...
    telegram_sphere = create_textured_rectangle(CSizeMake(560, 560), telegram_sphere_texture); // Adel
    telegram_plane = create_textured_rectangle(CSizeMake(148, 148), telegram_plane_texture); // Adel
